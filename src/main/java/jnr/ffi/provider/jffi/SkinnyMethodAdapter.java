...
public class SkinnyMethodAdapter extends MethodVisitor implements Opcodes {
    ...
    public void invokestatic(Class recv, String methodName, Class returnType, Class... parameterTypes) {
        getMethodVisitor().visitMethodInsn(INVOKESTATIC, p(recv), methodName, sig(returnType, parameterTypes), recv.isInterface());
    }
    ...
    public void invokespecial(Class recv, String methodName, Class returnType, Class... parameterTypes) {
        getMethodVisitor().visitMethodInsn(INVOKESPECIAL, p(recv), methodName, sig(returnType, parameterTypes), recv.isInterface());
    }
    ...
    public void invokevirtual(Class recv, String methodName, Class returnType, Class... parameterTypes) {
        getMethodVisitor().visitMethodInsn(INVOKEVIRTUAL, p(recv), methodName, sig(returnType, parameterTypes), recv.isInterface());
    }
    ...
    public void invokeinterface(Class recv, String methodName, Class returnType, Class... parameterTypes) {
        assert recv.isInterface();
        getMethodVisitor().visitMethodInsn(INVOKEINTERFACE, p(recv), methodName, sig(returnType, parameterTypes),true);
    }
    ...
    public void getstatic(Class<?> holder, String name, Class<?> type) {
        getMethodVisitor().visitFieldInsn(GETSTATIC, p(holder), name, ci(type));
    }
    ...
    public void getfield(Class<?> holder, String name, Class<?> type) {
        getMethodVisitor().visitFieldInsn(GETFIELD, p(holder), name, ci(type));
    }
